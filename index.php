   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         ...
         <section class="home-banner-section home-banner-slider">
                     ...
                     <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                           ...
                           <div class="banner-btn">
                              ...
                              <a href="./package.php" class="outline-btn outline-btn-white white-button">BOOK NOW</a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="home-banner d-flex flex-wrap align-items-center" style="background-image: url(./assets/images/banner-img2.jpg);">
               <div class="overlay"></div>
               <div class="container">
                  <div class="banner-content text-center">
                     <div class="row">
                  ...
                  <div class="col-lg-8 offset-lg-2 text-center">
                     <div class="callback-content">
                        ...
                        <div class="callback-btn">
                           ...
                           <a href="about.php" class="outline-btn outline-btn-white white-button">Learn More</a>
                        </div>
                     </div>
                  </div>
               </div>
